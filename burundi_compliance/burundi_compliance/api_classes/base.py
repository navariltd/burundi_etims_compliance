...
class OBRAPIBase:
        ...
        try:
            ...
            try:
                ...
                frappe.log_error(
                    ...
                    "OBRAPIBase Authentication Error",
                )
    ...
    def get_auth_details(self):
        try:
            ebims_settings = frappe.get_doc(
                "eBMS Settings", frappe.defaults.get_user_default("Company")
            )

            auth_details = {
                "username": ebims_settings.username,
                "password": ebims_settings.get_password(
